...
def procesar_bloque_especifico(lista_ligas, cantidad, modo_bloque="normal"):
    ...
    # ✅ CORREGIDO: Log total de ligas (Problema 3)
    ...
    for liga in lista_ligas:
        ...
        # ✅ CORREGIDO: Validación de league_id (Problema 2)
    ...
    # ✅ CORREGIDO: Logging detallado de picks por liga con snake_case (Problema 3)
    picks_por_liga = {}
...
async def ejecutar_bloque_remodelado(nombre_bloque, ligas, cantidad, modo="normal", intro=None):
    ...
    # ✅ CORREGIDO: Lógica de 3 intentos con espera de 10 minutos
    picks_bloque = []
